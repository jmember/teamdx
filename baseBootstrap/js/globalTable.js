function createGATable(eventString, divTag) {        
        // Get firebase reference
        var ref = new Firebase("https://flickering-fire-9736.firebaseio.com/" + eventString);
        ...
        ref.once('value',function(snap) {
          ...
          // creates <table> and <tbody> elements
            ...
            currenttext1 = document.createTextNode("Attribute Name");
